...
from inveniordm_auth import OAuthClientConfig
...
class BaseProxyHandler(tornado.web.RequestHandler):
    ...
    def oauth_config(self) -> OAuthClientConfig:
        return self.settings["inveniordm_oauth_config"]

    @property
    def token_store(self) -> MultiTokenStore:
        return self.settings["inveniordm_token_store"]
    ...
    def current_inveniordm_user_id(self) -> str | None:
