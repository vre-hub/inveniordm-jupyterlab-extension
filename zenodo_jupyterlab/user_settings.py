...
class ZenodoUserSettings(ABC):
    ...
    def get_default_downloads_directory(self) -> Path:
        ...
        """
        return self.jupyterlab_root_dir / "zenodo_downloads"

    def get_downloads_directory(self) -> Path:
        """
        Get the directory where Zenodo downloads are stored.
        """
    ...
    def set_downloads_directory(self, path: str):
        """
        Set the directory where Zenodo downloads should be stored.
