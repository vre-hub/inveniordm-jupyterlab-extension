...
import {
  InvenioRDMVersionedRecordBase,
  InvenioRDMVersionedRecordBaseProps
} from '../core';
import { ErrorPanel } from './ErrorPanel';

type InvenioRDMVersionedRecordProps = Omit<
  InvenioRDMVersionedRecordBaseProps,
 ...
 */
export function InvenioRDMVersionedRecord(
  props: InvenioRDMVersionedRecordProps
): JSX.Element {
  return (
    <InvenioRDMVersionedRecordBase
      {...props}
